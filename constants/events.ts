...
export const events: Array<Event<eventType>> = [
  ...
  // EXTENDED 13.10 PIĄTEK
  {
    ...
    datetime_end: new Date(2023, 9, 13, 9, 0),
    locationId: "d4ade18f-b40d-4f9d-8b05-430dd847df58",
    basic_or_extended: "extended",
  },
  {
    ...
    name: "Wyjazd na WAT",
    type: "attraction",
    datetime_start: new Date(2023, 9, 13, 9, 0),
    datetime_end: new Date(2023, 9, 13, 9, 0),
  ...
  },
  {
    ...
    name: "Atrakcje WAT",
    type: "attraction",
    datetime_start: new Date(2023, 9, 13, 10, 0),
    datetime_end: new Date(2023, 9, 13, 13, 30),
  ...
  },
  {
    ...
    name: "Open space",
    type: "attraction",
    datetime_start: new Date(2023, 9, 13, 13, 30),
    datetime_end: new Date(2023, 9, 13, 14, 45),
  ...
  },
  {
    ...
    name: "Obiad",
    datetime_start: new Date(2023, 9, 13, 14, 45),
  ...
  },
  {
    ...
    datetime_end: new Date(2023, 9, 13, 16, 0),
    basic_or_extended: "extended",
  },
  // BASIC 13.10 PIĄTEK
  {
    ...
    datetime_end: new Date(2023, 9, 13, 17, 30),
    locationId: "d4ade18f-b40d-4f9d-8b05-430dd847df58",
  ...
  },
  {
    ...
    type: "main event",
    datetime_start: new Date(2023, 9, 13, 17, 30),
    datetime_end: new Date(2023, 9, 13, 17, 30),
    locationId: "9e54f21e-f3e6-4d46-a2c5-a0d3657c354a",
    description: "Prosimy o punktualne przybycie.",
  ...
  },
  {
    ...
    datetime_end: new Date(2023, 9, 13, 20, 0),
  ...
  },
  {
    ...
    name: "Integracja",
    type: "attraction",
    datetime_start: new Date(2023, 9, 13, 20, 0),
  ...
  },
  {
    ...
    datetime_end: new Date(2023, 9, 14, 19, 30),
  },
  {
